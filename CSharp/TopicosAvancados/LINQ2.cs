...
namespace CSharp.TopicosAvancados {
    class LINQ2 {
        public static void Executar() {
            ...
            // Se o valor não for encontrado é retornado um Excesão
            ...
            var sicrano = alunos.SingleOrDefault(aluno => aluno.Nome.Equals("Sicrano"));
            if (sicrano == null)
                Console.WriteLine("Aluno Inexistente!");
            ...
            // Ao varrer a lista, ele pulará um aluno, e após isso, pegará três
